...
fig = plot_topic_heatmap(
    ...
    feature_names,
    figsize=(16, 6),
    save_path='/home/coder/sLDA_co_pathology/figures/topic_heatmap.png'
)
plt.show()
...
for topic_id in range(model.n_topics):
    fig = plot_brain_topic_pattern(
        ...
        n_top_regions=12,
        figsize=(14, 5),
        save_path=f'/home/coder/sLDA_co_pathology/figures/topic_{topic_id}_brain_pattern.png'
    )
    plt.show()
...
fig = plot_patient_topic_distribution(
    ...
    dx_labels,
    figsize=(14, 6),
    save_path='/home/coder/sLDA_co_pathology/figures/patient_topic_distribution.png'
)
plt.show()
...
fig = plot_topic_diagnosis_association(
    ...
    dx_labels,
    figsize=(9, 6),
    save_path='/home/coder/sLDA_co_pathology/figures/topic_diagnosis_association.png'
)
plt.show()
...
topic_df.to_csv('/home/coder/sLDA_co_pathology/results/260109_topic_patterns.csv')
...
dx_weights_df.to_csv('/home/coder/sLDA_co_pathology/results/260109_topic_diagnosis_weights.csv')
